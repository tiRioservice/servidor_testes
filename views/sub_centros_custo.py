...
def insert_sub_centro_custo():
    ...
    if json != {}:
        if 'name' in json:
            ...
            return jsonify({
                "method":"POST",
                "action":f"Inserir um novo sub centro de custo.",
                "data":json
            })
...
def get_sub_centros_custo():
    return jsonify({
        "method":"GET",
        "action":"Listar todos os sub centros de custo.",
        "data":lista
    })
    ...
    if 'id' in data:
        for register in lista:
            if register['id'] == data['id']:
                return jsonify({
                    "method":"GET",
                    "action":f"Buscar o sub centro de custo de ID {data['id']}.",
                    "data":register
                })
        ...
        if 'data' in data:
            for register in lista:
                if register['id'] == data['id']:
                    ...
                    return jsonify({
                        "method":"POST",
                        "action":f"Atualizar o sub centro de custo de ID {data['id']}.",
                        "data":data
                    })
...
def remove_sub_centro_custo():
    ...
    if 'id' in data:
        ...
        return jsonify({
            "method":"POST",
            "action":f"Remover o sub centro custo de ID {data['id']}.",
        })
    return jsonify({"msg":"Insira um ID."})